...
import 'package:app_1/src/cart/widgets/cart_counter.dart';
import 'package:app_1/src/cart/widgets/update_button.dart';
...
class CartTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final formattedPrice = NumberFormat.currency(
      ...
      symbol: '',
      decimalDigits: 0,
    ).format(cart.quantity * cart.product.price);
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: ScreenUtil().screenWidth *
                                  0.5, // Chiều rộng tối đa là 50% màn hình
                              child: Text(
                                cart.product.title,
                                style: appStyle(
                                    12, Kolors.kDart, FontWeight.normal),
