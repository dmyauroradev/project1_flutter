...
import 'package:app_1/src/cart/hooks/fetch_cart.dart';
import 'package:app_1/src/cart/widgets/cart_tile.dart';
                        ...
                        children: [
                          Padding(
                            ...
                            child: ReusableText(
                                text: 'THANH TOÁN',
                                style: appStyle(
                                    16, Kolors.kWhite, FontWeight.w600)),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: ReusableText(
                                text:
                                    '${NumberFormat("#,###", "vi_VN").format(cartNotifier.totalPrice)} VNĐ',
                                style: appStyle(
                                    16, Kolors.kWhite, FontWeight.w600)),
                          ),
                        ],
