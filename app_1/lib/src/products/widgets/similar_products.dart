...
import 'package:app_1/common/widgets/empty_widget.dart';
...
import 'package:app_1/src/products/hooks/fetch_similar.dart';
        ...
        : Padding(
            ...
            child: StaggeredGrid.count(
              ...
              children: List.generate(products.length, (i) {
                ...
                final double mainAxisCellCount = (product.title.length > 30)
                    ? 2.5
                    : 2.2; //(i % 2 == 0 ? 2.17 : 2.4);
